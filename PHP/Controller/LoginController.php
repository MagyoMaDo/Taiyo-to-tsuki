...
class LoginController{
    ...
    if(isset($_SESSION['msg']) && !isset($_SESSION['usuario']) && !isset($_SESSION['email'])){
            ...
            $MensagemDeErro = $rendeneriza->arquivo("MensagemDeErro2.html", ["mensagemDeErro"], [$_SESSION['msg']]);
            ...
            $MensagemDeErro = $rendeneriza->arquivo("MensagemDeErro2.html", ["mensagemDeErro"], ["Usuario já cadastrado"]);
            ...
            $MensagemDeErro=  $rendeneriza->arquivo("MensagemDeErro2.html", ["mensagemDeErro"],[""]);
